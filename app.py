...
from PyQt5.QtWidgets import QGraphicsScene, QGraphicsView, QVBoxLayout, QComboBox, QCheckBox, QFrame, QHBoxLayout, QTextEdit, QMainWindow, QGraphicsDropShadowEffect, QLabel
...
class SplashScreen(QMainWindow):
    def __init__(self):
        ...
        # Change Texts
        QtCore.QTimer.singleShot(1500, lambda: self.ui.loading_label.setText("<strong>LOADING</strong> SHAPEFILES"))
...
shapefile_path = r'D:\Downloads\Administrative Boundary Database\STATE_BOUNDARY.shp' 
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dam_label = QtWidgets.QLabel(self.gridLayoutWidget)
        self.dam_label.setFont(font)
        self.dam_label.setObjectName("dam_label")
        self.gridLayout_2.addWidget(self.dam_label, 2, 0, 1, 1)

        self.damlineEdit = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.damlineEdit.setObjectName("damlineEdit")
        self.gridLayout_2.addWidget(self.damlineEdit, 2, 1, 1, 2)
        ...
        self.checkBox = QLabel(self.frame)
        ...
        self.checkBox_2 = QLabel(self.frame)
        ...
        self.checkBox_3 = QLabel(self.frame)
        ...
        self.checkBox_4 = QLabel(self.frame)
        ...
        self.checkBox_5 = QLabel(self.frame)
        ...
        self.checkBox_6 = QLabel(self.frame)
        ...
        self.checkBox_7 = QLabel(self.frame)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QIcon(r'D:\CS\GitHub\Nuclear-Site-Selection\Optics\WhatsApp Image 2024-07-02 at 18.24.47_01ef9468.jpg'))
        self.menuFile.setTitle(_translate("MainWindow", "File"))
        self.menuHelp.setTitle(_translate("MainWindow", "Help"))
        self.actionExport_Report.setText(_translate("MainWindow", "Export Report"))
        self.actionExit.setText(_translate("MainWindow", "Exit"))
        self.actionAbout.setText(_translate("MainWindow", "About"))
        self.dam_label.setText(_translate("MainWindow", "Selected Dam"))
        self.label.setText(_translate("MainWindow", "Parameters"))
        self.label_2.setText(_translate("MainWindow", "Observed Values"))
        self.label_3.setText(_translate("MainWindow", "Threshold Values"))
        self.checkBox.setText(_translate("MainWindow", "Earthquake risk"))
        self.checkBox_2.setText(_translate("MainWindow", "Population Density"))
        ...
        self.SlineEdit.setText('Seismic Zone II')
        self.SlineEdit_2.setText("300 per sq.km")
        self.SlineEdit_3.setText("100 km")
        self.SlineEdit_4.setText("100 km")

    def show_about(self):
        about_text = """
        <h2>About Nucleosite</h2>
        <p>NucleoSite is a pilot desktop application designed to streamline the process of finding suitable locations for nuclear power plants. It provides an interactive map interface with zoom and coordinate conversion capabilities, allowing users to select states and view corresponding dams and their associated grid points. The application displays detailed information about selected dams, such as earthquake risk, population density, proximity to highways and airports, soil/geotechnical conditions, mining activities, and wind speed.</p>
        <h3>Features:</h3>
        <ul>
    ...
    def add_dam_info_plot(self, dam):
        ...
        self.info_ax = self.figure.add_axes([0.75, 0.01, 0.3, 0.25])  # Adjust position and size as needed
    ...
    def update_parameters(self, dam):
        self.damlineEdit.setText(str(dam['dm_name']))
        self.damlineEdit.setReadOnly(True)
        self.lineEdit.setText(str(dam['dm_ses_zon']))
        self.lineEdit.setReadOnly(True)
        self.lineEdit_2.setText(str(dam['Avg_population']) + "per sq.km")
    ...
    def capture_canvas(self):
        ...
        image_path = os.path.join(r"D:\CS\GitHub\Nuclear-Site-Selection\Data\Canvass Pictures", "image.png")  # More reliable path handling
    ...
    def export_report(self):
        ...
        coordinates = f"{self.selected_dam.dm_long}, {self.selected_dam.dm_lat}"
        ...
        image_path = r"D:\CS\GitHub\Nuclear-Site-Selection\Data\Canvass Pictures\image.png"
        ...
        headers = ["S.No", "Data", "Current Values", "Threshold Value", "Result"]
        ...
        # Table rows
        factors = {
            "Earthquake Risk": (self.lineEdit.text(),self.SlineEdit.text()),
            "Population Density": (self.lineEdit_2.text(),self.SlineEdit_2.text()),
            "Nearest Highway": (self.lineEdit_3.text(), self.SlineEdit_3.text()),
            "Nearest Airport": (self.lineEdit_4.text(),self.SlineEdit_4.text()),
            "Soil/Geotechnical": (self.lineEdit_5.text(),self.SlineEdit_5.text()),
            "Mining": (self.lineEdit_6.text(),self.SlineEdit_6.text()),
            "Wind Speed": (self.lineEdit_7.text(),self.SlineEdit_7.text())
        }

        def determine_status(factor, values):
            # Example criteria for determining status
            if factor == "Earthquake Risk":
                return "Fail"
            elif factor == "Population Density":
                return "Pass"
            elif factor == "Nearest Highway":  # Example dynamic condition
                return "Pass"
            else:
                return ""
        ...
        for idx, (factor, values) in enumerate(factors.items(), 1):
            threshold_value, default_current_value = values
            status_value = determine_status(factor, values)
            ...
            pdf.cell(column_width, 10, status_value, 1)
            pdf.ln()
